...
This code is for the Question 8 in the Homework 1 of AERSP 424

Author: Xue (Aria) Wang

using modern CPP-style pointer in Quetion 8
...
public:
    ...
    // Use modern CPP-style pointer for Plane object
...
int main() {
    ...
    // Create one shared plane using shared_ptr
    shared_ptr<Plane> myPlane = make_shared<Plane>("SCE", "PHL", flights);

    // Assign the plane to the first pilot
    ...
    cout << pilot1.getName() << " with certificate number " << &pilot1 << " is in control of a plane: " << pilot1.myPlane.get()  << endl;
    cout << pilot2.getName() << " with certificate number " << &pilot2 << " is in control of a plane: " << pilot2.myPlane.get()  << endl;
    cout << " " << endl;
    ...
    for (int i = 0; i < max_iterations; i++) {
        ...
        //Only swap route if the destination was NOT SCE 
        if (!myPlane->getAtSCE()) {
            myPlane->swapRoute();
        }
        ...
        cout << pilot1.getName() << " with certificate number " << &pilot1 << " is in control of the plane: " << pilot1.myPlane.get() << endl;
        cout << pilot2.getName() << " with certificate number " << &pilot2 << " is in control of the plane: " << pilot2.myPlane.get() << endl;
        cout << " " << endl;
    }
